...
if(typeof document != "undefined"){
  ...
  let plot = (e)=>{
    ...
    cnv.lineWidth = 3;
    for( let i in points ){
      cnv.strokeStyle = "hsl("+Math.floor(330*i/points.length)+",90%,40%)";
